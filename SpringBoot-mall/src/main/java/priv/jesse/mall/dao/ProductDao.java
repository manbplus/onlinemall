  ...
  priv.jesse.mall.entity.Product;
 ...
 /**
	 ...
	 */
		  @Query(value =
		  "SELECT * FROM (SELECT  * FROM product ORDER BY pdate DESC limit 0,24) a /*#pageable"
		  ,nativeQuery = true) List<Product> findNew(Pageable pageable); }
